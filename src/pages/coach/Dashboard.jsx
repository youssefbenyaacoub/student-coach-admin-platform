                        ...
                        <div className="flex-1 overflow-hidden grid grid-rows-2 md:grid-rows-1 md:grid-cols-2">
                            ...
                            <div className="flex flex-col border-r border-border h-full max-h-full p-6 bg-slate-50/30">
                                <div className="flex items-center justify-between mb-4">
                                    ...
                                    <button
                                        onClick={() => window.dispatchEvent(new CustomEvent('sea:open-chat', { detail: { peerId: selectedStudentId } }))}
                                        className="text-xs font-semibold text-coach-primary hover:underline flex items-center gap-1"
                                    >
